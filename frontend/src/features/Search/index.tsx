...
export const Search = () => {
	...
	return (
		<div className='flex items-center gap-2.5'>
			...
			<form
				onSubmit={onSubmit}
				className='flex items-stretch overflow-hidden sm:w-[267px]'
			>
				<input
					name='text'
					className='text-text bg-bg vsm:px-3.5 vsm:py-4 w-full rounded-l-2xl px-2 py-3 text-xs placeholder:text-xs dark:bg-[#0e0e0e]'
